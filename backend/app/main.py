...
# import fitz  # PyMuPDF - Temporarily commented out
# from sentence_transformers import SentenceTransformer - Temporarily commented out
# import chromadb - Temporarily commented out
import uuid
# from google import genai - Temporarily commented out
# import dotenv - Temporarily commented out
from app.routers import auth, users
from app.database import connect_to_mongo, close_mongo_connection

# --- Config ---
# Gemini GenAI API key
# GENAI_API_KEY=dotenv.get_key(".env", "GENAI_API_KEY") - Temporarily commented out
# Initialize embedding model
# embed_model = SentenceTransformer("all-mpnet-base-v2") - Temporarily commented out

# Initialize ChromaDB (local persistent storage) - Temporarily commented out
# client_chroma = chromadb.PersistentClient(path="./chroma_db")
# collection = client_chroma.get_or_create_collection(name="pdf-embeddings")

# Initialize Gemini GenAI client - Temporarily commented out
...
# --- Models --- (Temporarily commented out for basic server functionality)
...
# --- Helper Functions --- (Temporarily commented out for basic server functionality)
...
# --- Endpoints --- (PDF processing endpoints temporarily commented out)
